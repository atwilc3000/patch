...
static int insmod(const char *filename, const char *args)
{
...
#ifdef WILC3000_WIFI_USED
	acquire_wake_lock(PARTIAL_WAKE_LOCK, WAKE_LOCK_ID); //[[ Add ATMEL KR 1227
#endif
	...
	{
#ifdef WILC3000_WIFI_USED
       release_wake_lock(WAKE_LOCK_ID); //[[ Add ATMEL KR 1227
#endif
       return -1;
	}
